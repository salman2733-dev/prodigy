...
export default function GetPage() {
  ...
  return (
    // Parent (light transparent background)
      <div className="fixed inset-0 bg-[rgba(102,96,96,0.55)] flex items-center justify-center">

      <div className="min-h-screen bg-transparent flex items-center justify-center p-6">


      {/* Card */}
      <div className="relative bg-white border-2 border-cyan-500 rounded-2xl shadow-2xl 
        w-[50%] max-w-4xl p-8 flex flex-col animate-slideIn">
        ...
        <div className="text-center mb-6 mt-6">
          <h1 className="text-3xl font-bold">Sign in to Job Portal</h1>
        ...
        <button className="w-full py-3 px-4 mb-4 bg-gray-100 border-2 border-cyan-500 
          rounded-2xl hover:border-cyan-400 flex items-center justify-center gap-3 transition">
        ...
        <input
          ...
          className="w-full px-5 py-3 mb-4 bg-gray-100 border-2 border-cyan-500 
            rounded-2xl focus:outline-none focus:border-cyan-400 transition 
            text-black placeholder-gray-400"
        />

        {/* Continue Button */}
        <button className="w-full py-3 px-4 bg-cyan-500 text-black 
          font-medium rounded-2xl hover:bg-cyan-400 transition flex items-center justify-center gap-2">
          Continue
